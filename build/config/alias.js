...
module.exports = function (srcConfig) {
  ...
  return {
    ...
    '@': path.resolve(SRC_RELATIVE_PATH),
    ...
    // 页面逻辑组件相关
    'modules': path.resolve(SRC_RELATIVE_PATH, 'modules'),
    // common 模块下的modules
    ...
    // 用户信息
    'user': path.resolve(SRC_RELATIVE_PATH, 'common/utils/user'),
    // http请求封装
