...
const $common = {
   ...
   * @example
   * 浅拷贝 common.copy({name: 'duqiao'}, {age: 18}) => { name: 'duqiao', age: 18 }
   * 深拷贝 common.copy(true, {name: 'duqiao', age: 18, obj: {sex: '1', love: 'bei'}}, {name: 'deep', obj: {sex: '2'}}) => { name: 'deep', age: 18, obj: { sex: 2, love: 'bei' } }
   */
  copy () {
